...
| # | Tool | Description |
|---|------|-------------|
| 1 | **Password Strength Analyzer** | Checks length, complexity, common patterns, and estimates entropy in bits |
| 2 | **Secure Password Generator** | Generates strong passwords with customizable length and character sets |
...
```bash
git clone https://github.com/Jdog1x/cyberkit.git
cd cyberkit
python cyberkit.py
```
